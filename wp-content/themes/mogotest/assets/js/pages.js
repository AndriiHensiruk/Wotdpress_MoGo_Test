const mogo = document.querySelector("#root");
mogo.innerHTML = `
<!-- ! header -->
		...
		<main class="main">
					...
					<div class="card">
						<div class="card__item">
							<div class="card__inner">
								<div class="card__img">
									<img src="Mogo/img/about/1.jpg" alt="" />
								</div>
						...
						<div class="card__item">
							<div class="card__inner">
								<div class="card__img">
									<img src="Mogo/img/about/2.jpg" alt="" />
								</div>
								<div class="card__text">super team</div>
							</div>
						</div>
						...
						<div class="card__item">
							<div class="card__inner">
								<div class="card__img">
									<img src="Mogo/img/about/3.jpg" alt="" />
								</div>
								<div class="card__text">super team</div>
							</div>
						</div>
					...
					<div class="services">
						<div class="services__item services__item--border">
							<img
								...
								src="Mogo/img/services/photography.png"
								alt="" />
						...
						<div class="services__item services__item--border">
							<img
								class="services__icon"
								src="Mogo/img/services/webdesign.png"
								alt="" />
						...
						<div class="services__item services__item--border">
							<img
								class="services__icon"
								src="Mogo/img/services/creativity.png"
								alt="" />
						...
						<div class="services__item">
							<img
								class="services__icon"
								src="Mogo/img/services/css-html.png"
								alt="" />
						...
						<div class="services__item">
							<img
								class="services__icon"
								src="Mogo/img/services/digital.png"
								alt="" />
			...
			<section class="section section--devices">
				<div class="container">
					...
					<div class="devices">
						<img class="devices__item" src="Mogo/img/ipad.png" alt="" />
						<img
							class="devices__item devices__item--iphone"
							src="Mogo/img/iphone.png"
							alt="" />
					</div>
				</div>
			</section>
				...
				<div class="container">
					...
					<div class="wedo">
						<div class="wedo__item">
							<img class="wedo__img" src="Mogo/img/wedo.jpg" alt="" />
						</div>
				...
				<div class="container">
					...
					<div class="card">
						<div class="card__item">
							<div class="card__inner">
								<div class="card__img">
									<img src="Mogo/img/team/1.jpg" alt="" />
								</div>
						...
						<div class="card__item">
							<div class="card__inner">
								<div class="card__img">
									<img src="Mogo/img/team/2.jpg" alt="" />
								</div>
								<div class="card__text">
									<div class="social">
										<a class="social__item" href="#" target="_blank">
						...
						<div class="card__item">
							<div class="card__inner">
								<div class="card__img">
									<img src="Mogo/img/team/3.jpg" alt="" />
								</div>
								<div class="card__text">
									<div class="social">
										<a class="social__item" href="#" target="_blank">
				...
				<div class="container">
					<div class="logos">
						<div class="logos__item">
							<img class="logos__img" src="Mogo/img/logos/1.png" alt="" />
						</div>
						<div class="logos__item">
							<img class="logos__img" src="Mogo/img/logos/2.png" alt="" />
						</div>
						<div class="logos__item">
							<img class="logos__img" src="Mogo/img/logos/3.png" alt="" />
						</div>
						<div class="logos__item">
							<img class="logos__img" src="Mogo/img/logos/4.png" alt="" />
						</div>
						<div class="logos__item">
							<img class="logos__img" src="Mogo/img/logos/5.png" alt="" />
						</div>
						<div class="logos__item">
							<img class="logos__img" src="Mogo/img/logos/6.png" alt="" />
						</div>
					</div>
				</div>
			</div>
				...
				<div class="works">
					<div class="works__col">
						<div class="works__item">
							<img class="works__image" src="Mogo/img/works/1.jpg" alt="" />
						...
						<div class="works__item">
							<img class="works__image" src="Mogo/img/works/2.jpg" alt="" />
							<div class="works__info">
								<div class="works__title">creatively designed</div>
								<div class="works__text">Lorem ipsum dolor sit</div>
							</div>
					...
					<div class="works__col">
						<div class="works__item">
							<img class="works__image" src="Mogo/img/works/3.jpg" alt="" />
							<div class="works__info">
								<div class="works__title">creatively designed</div>
								<div class="works__text">Lorem ipsum dolor sit</div>
							</div>
						...
						<div class="works__item">
							<img class="works__image" src="Mogo/img/works/4.jpg" alt="" />
							<div class="works__info">
								<div class="works__title">creatively designed</div>
								<div class="works__text">Lorem ipsum dolor sit</div>
							</div>
					...
					<div class="works__col">
						<div class="works__item">
							<img class="works__image" src="Mogo/img/works/5.jpg" alt="" />
							<div class="works__info">
								<div class="works__title">creatively designed</div>
								<div class="works__text">Lorem ipsum dolor sit</div>
							</div>
					...
					<div class="works__col">
						<div class="works__item">
							<img class="works__image" src="Mogo/img/works/6.jpg" alt="" />
							<div class="works__info">
								<div class="works__title">creatively designed</div>
								<div class="works__text">Lorem ipsum dolor sit</div>
							</div>
						...
						<div class="works__item">
							<img class="works__image" src="Mogo/img/works/7.jpg" alt="" />
							<div class="works__info">
								<div class="works__title">creatively designed</div>
								<div class="works__text">Lorem ipsum dolor sit</div>
							</div>
					...
					<div class="blog">
						<div class="blog__item">
							<div class="blog__header">
								<a href="#">
									<img class="blog__photo" src="Mogo/img/blog/1.jpg" alt="" />
								</a>
						...
						<div class="blog__item">
							<div class="blog__header">
								<a href="#">
									<img class="blog__photo" src="Mogo/img/blog/2.jpg" alt="" />
								</a>
								<div class="blog__date">
									<div class="blog__date-day">15</div>
									Jan
						...
						<div class="blog__item">
							<div class="blog__header">
								<a href="#">
									<img class="blog__photo" src="Mogo/img/blog/3.jpg" alt="" />
								</a>
								<div class="blog__date">
									<div class="blog__date-day">15</div>
									Jan
			...
			<footer class="footer" id="footer">
				<div class="container">
						...
						<div class="footer__col footer__col--second">
							...
							<div class="blogs">
								<div class="blogs__item">
									<img class="blogs__img" src="Mogo/img/blog/1.jpg" alt="" />
								...
								<div class="blogs__item">
									<img class="blogs__img" src="Mogo/img/blog/2.jpg" alt="" />
									<div class="blogs__content">
								...
								<div class="blogs__item">
									<img class="blogs__img" src="Mogo/img/blog/3.jpg" alt="" />
									<div class="blogs__content">
										<a class="blogs__title" href="#"
											>Lorem ipsum dolor sit amet, consectetur adipiscing</a
										>
						...
						<div class="footer__col footer__col--third">
							...
							<div class="instagram">
								<a class="instagram__item" href="#" target="_blank">
									<img src="Mogo/img/instagram/1.jpg" alt="" />
								</a>
								<a class="instagram__item" href="#" target="_blank">
									<img src="Mogo/img/instagram/2.jpg" alt="" />
								</a>
								<a class="instagram__item" href="#" target="_blank">
									<img src="Mogo/img/instagram/3.jpg" alt="" />
								</a>
								<a class="instagram__item" href="#" target="_blank">
									<img src="Mogo/img/instagram/4.jpg" alt="" />
								</a>
								<a class="instagram__item" href="#" target="_blank">
									<img src="Mogo/img/instagram/5.jpg" alt="" />
								</a>
								<a class="instagram__item" href="#" target="_blank">
									<img src="Mogo/img/instagram/6.jpg" alt="" />
								</a>
								<a class="instagram__item" href="#" target="_blank">
									<img src="Mogo/img/instagram/7.jpg" alt="" />
								</a>
								<a class="instagram__item" href="#" target="_blank">
									<img src="Mogo/img/instagram/8.jpg" alt="" />
								</a>
								<a class="instagram__item" href="#" target="_blank">
									<img src="Mogo/img/instagram/9.jpg" alt="" />
								</a>
							</div>
						</div>
					</div>
					...
					<div class="copyright">
						© 2022 DevX By
						<a href="https://github.com/AndriiHensiruk" target="_blank"
							><span>Mogo</span></a
						>
					</div>
				</div>
